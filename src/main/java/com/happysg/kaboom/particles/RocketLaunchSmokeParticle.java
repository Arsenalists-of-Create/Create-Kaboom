...
@OnlyIn(Dist.CLIENT)
public class RocketLaunchSmokeParticle extends TextureSheetParticle {
    ...
    protected RocketLaunchSmokeParticle(ClientLevel level,
        ...
        this.startSize = 0.32F + this.random.nextFloat() * 0.16F;
        this.endSize = this.startSize * (1.8F + this.random.nextFloat() * 0.6F);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
                                       double x, double y, double z,
                                       double xd, double yd, double zd) {
            return new RocketLaunchSmokeParticle(level, x, y, z, xd, yd, zd, this.sprites);
        }
    }
}
