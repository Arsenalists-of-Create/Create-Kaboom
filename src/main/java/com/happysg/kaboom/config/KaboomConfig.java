...
public class KaboomConfig {
    private static final Map<ModConfig.Type, ConfigBase> CONFIGS = new EnumMap<>(ModConfig.Type.class);

    private static KaboomClientConfig client;
    private static KaboomServerConfig server;
    ...
    public static BaseConfigScreen createConfigScreen(Minecraft mc, Screen parent) {
        ...
        return new BaseConfigScreen(parent, CreateKaboom.MODID);
    }
}
